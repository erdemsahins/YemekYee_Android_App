...
public  class YemekSiparisV2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextActionBar=findViewById(R.id.editText2_restoranno_action_bar);
        editTextActionBar.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if(x.startsWith("0"))
                {
                    ...
                    Toast.makeText(getApplicationContext(),"restoran Numarası 0 İle Başlayamaz!",Toast.LENGTH_LONG).show();
                }else {
                    Urunler.Siparis_restoran_No=editTextActionBar.getText().toString();
                    Log.d("A_Degisen Sayimiz",Urunler.Siparis_restoran_No);
                }
