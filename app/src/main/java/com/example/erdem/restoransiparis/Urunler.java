...
import static com.example.erdem.restoransiparis.Siparis_icecek.SiparisVerIcecek;
import static com.example.erdem.restoransiparis.Siparis_tatli.SiparisVerTatli;
import static com.example.erdem.restoransiparis.Siparis_yemek.SiparisVerYemek;

public class Urunler {

    public String urun_name;
    public int urun_siparis_miktar=0;
    public static String Siparis_restoran_No="";
    ...
    public static void SiparisDatabaseKayit(){
        ...
        try {
            ...
            databaseReference.child("SiparisList").child(Siparis_restoran_No).updateChildren(childUpdates);
    ...
    public static String UrunKayitKontrol(){
        ...
        if (!Urunler.Siparis_restoran_No.equals("") && !Urunler.Siparis_restoran_No.equals("0")){
            SiparisVerYemek();
            SiparisVerIcecek();
            SiparisVerTatli();
            ...
            if (Urunler.SiparisUrunListDBKayit.size()>0){
                ...
                // Güncelleme için yine restoran no ve sipariş girilmesi yeterli
